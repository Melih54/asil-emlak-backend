...
function AdminPaneli() {
  ...
  const pdfIndir = (kayit) => {
    ...
    // HTML İçeriği: Genişlik %100 yapıldı ve padding optimize edildi
    const htmlIcerik = `
      <div style="width: 100%; padding: 20px; font-family: 'Times New Roman', serif; font-size: 13px; line-height: 1.4; color: #000; background: #fff; box-sizing: border-box;">
        ...
        <h3 style="font-size: 15px; text-decoration: underline; margin-bottom: 5px;">MADDE 1 - TARAFLAR</h3>
        ...
        <h3 style="font-size: 15px; text-decoration: underline; margin-top: 15px; margin-bottom: 5px;">MADDE 2 - SÖZLEŞMENİN KONUSU</h3>
        ...
        <h3 style="font-size: 15px; text-decoration: underline; margin-top: 15px; margin-bottom: 5px;">MADDE 3 - DİJİTAL ONAY VE KVKK</h3>
    ...
    const ayarlar = { 
      margin: [10, 10, 10, 10], // Kenar boşluklarını biraz artırmak daha profesyonel durur
